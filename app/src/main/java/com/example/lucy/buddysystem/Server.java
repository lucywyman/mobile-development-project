...
import com.example.lucy.buddysystem.http.HttpPost;
...
public class Server {
    ...
    public long send(Limerick entry) throws Exception {
        ...
        post.addFormField("name", entry.getTitle());
        post.addFormField("lastName", entry.getBlather());
    ...
    private static String getUrl() {
        return "http://cs496-buddysytem.appspot.com/hello";
    }
}
